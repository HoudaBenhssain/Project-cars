        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
          <div className="space-y-4 p-4 rounded-lg hover:bg-white/5 transition-colors">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg md:text-xl font-bold">
                Rent Car
                <span className="block text-xs md:text-sm font-normal">
                  Service
                </span>
              </h2>
            </div>
            <p className="text-gray-400 text-xs md:text-sm leading-relaxed pt-15">
              ...
              ipsa neque harum quod quae reiciendis et quasi illum alias. Vero
              ipsam a omnis! Totam nam eaque sequi voluptates doloribus?
            </p>
          </div>
          ...
          <div className="p-4 rounded-lg hover:bg-white/5 transition-colors">
            ...
            >
              ...
              <svg
                className={`w-5 h-5 transition-transform ${
                  isMenuOpen.quickLinks ? "rotate-180" : ""
                }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <ul
              className={`space-y-2 overflow-hidden transition-all duration-300 ease-in-out ${
                isMenuOpen.quickLinks ? "max-h-48" : "max-h-0 md:max-h-48"
              }`}
            >
          ...
          <div className="p-4 rounded-lg hover:bg-white/5 transition-colors">
            ...
            >
              ...
              <svg
                className={`w-5 h-5 transition-transform ${
                  isMenuOpen.headOffice ? "rotate-180" : ""
                }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <div
              className={`space-y-2 text-gray-400 overflow-hidden transition-all duration-300 ease-in-out ${
                isMenuOpen.headOffice ? "max-h-48" : "max-h-0 md:max-h-48"
              }`}
            >
          ...
          <div className="p-4 rounded-lg hover:bg-white/5 transition-colors">
            ...
            >
              ...
              <svg
                className={`w-5 h-5 transition-transform ${
                  isMenuOpen.newsletter ? "rotate-180" : ""
                }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ease-in-out ${
                isMenuOpen.newsletter ? "max-h-48" : "max-h-0 md:max-h-48"
              }`}
            >
